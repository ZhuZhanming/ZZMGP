	...
	<div class="global">
		<div class="log log_in" tabindex='-1' id='dl'>
			<dl>
				...
				<dt>
					<div class='letter'>
						账&nbsp;号:&nbsp;<input type="text" name="" id="code" tabindex='1' /> <span
				...
				<dt>
					<div>
						<input type="button" id="login" value='&nbsp登&nbsp录&nbsp' tabindex='3' />
						<input type="button" id="sig_in" value='&nbsp注&nbsp册&nbsp' tabindex='4' />
					</div>
				</dt>
			</dl>
		</div>
		<div class="sig sig_out" tabindex='-1' id='zc'
			...
			<dl>
				...
				<dt>
					<div class='letter'>
						姓&nbsp;名:&nbsp;<input type="text" name="" id="nickname" tabindex='6' />
					</div>
				</dt>
				<dt>
					<div class='letter'>
						账&nbsp;号:&nbsp;<input type="text" name="" id="regist_username" tabindex='5' />
				...
				<dt>
					<div class='letter'>
						重&nbsp;输:&nbsp;<input type="password" name="" id="final_pwd" tabindex='8' />
